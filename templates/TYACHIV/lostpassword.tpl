<div class="block story">
	<div class="wrp">
		<div class="head">
			<h1 class="title h2 ultrabold">Відновлення паролю</h1>
		</div>
		<ul class="ui-form">
			<li class="form-group">
		...
		<div class="form_submit">
			[sec_code]
				<div class="c-capcha">
					{code}
					<input placeholder="Повторіть код" title="Введіть код вказаний на малюнку" type="text" name="sec_code" id="sec_code" required>
				</div>
			[/sec_code]
