	...
	<div class="box_in">
		...
		<ul class="story_icons">
			<li class="fav_btn">
				...
				[del-favorites]<span title="Видалити із закладок"><svg class="icon icon-star"><use xlink:href="#icon-star"></use></svg></span>[/del-favorites]
			</li>
			<li class="edit_btn">
		...
		<div class="story_tools">
			...
			<a href="{full-link}" title="Читати детальніше: {title}" class="btn"><b>Детальніше</b></a>
			[rating]
				<div class="rate">
