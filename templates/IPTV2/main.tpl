...
<!--				<form id="q_search" class="rightside" method="post">
					<div class="q_search">
						...
						<a class="q_search_adv" href="/index.php?do=search&amp;mode=advanced" title="Поширений пошук"><svg class="icon icon-set"><use xlink:href="#icon-set"></use></svg><span class="title_hide">Поширений пошук</span></a>
					</div>
						...
						<div class="midside">
							<div id="header_menu">
								...
								<!--	<span class="logo_icon"><svg class="icon icon-logo"><use xlink:href="#icon-logo"></use></svg></span> -->
									<span class="logo_title">Тячів TV</span>
								</a>
								<!-- / Логотип -->
								<!-- Основное Меню -->
								<nav id="top_menu">
			...
			<div class="page_form__body">
				<div class="page_form__logo">
					...
					<!--	<svg class="icon icon-logo"><use xlink:href="#icon-logo"></use></svg> -->
						<span class="title_hide">Тячів TV</span>
					</a>
					<!-- / Логотип -->
				</div>
				{info}
